...
int childIndex = 0;
foreach (var Nghghfgh in bob.Children)
{
    WriteLine($" {bob.Children[childIndex].Name}");
    childIndex++;  
}//aqui estão 2 formas diferentes de fazer a mesma coisa
...
foreach (object passenger in passengers)
{
    decimal flightCost = passenger switch
    {
        ...
        */
        ...
        FirstClassPassenger => 2000M,
        // Tem 3 formas diferentes de resolver essa primeira parte, gostei bastante da última
...
var (who1, what2) = oscar; // calls Deconstruct method
WriteLine($"{who1} is a {what2}.");

...
static void FilterAndSort()
{
    using (Northwind db = new())
    {
      ...
      //  foreach (Product p in sortedAndFilteredProducts) // se fizer assim será um SELECT com todas as colunas
      //  {
...
static void JoinCategoriesAndProducts()
{
    using (Northwind db = new())
    {
        ...
        inner: db.Products,                    //aqui é feito o join entre as tabelas
        outerKeySelector: category => category.CategoryId,
        innerKeySelector: product => product.CategoryId, //aqui é feita relação de igualdade entre os CategoryId de cada tabela
        resultSelector: (c, p) =>
        new { c.CategoryName, p.ProductName, p.ProductId });   // é a parte de cima,o SELECT da tabela criada

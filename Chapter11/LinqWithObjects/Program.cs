...
//var query = names.Where(NameLongerThanFour); //forma reduzida removendo o explicit delegate instantiation
//var query = names.Where(name => name.Length > 4); // forma mais reduzida ainda usando expressão lambda
